...
There are various ways to construct a confidence interval for an estimated binomial distribution. We use three different methods, all of which provide very similar estimates.
...
We create a summary table similar to the table in b, but this time we compare the means of smokers vs non-smokers. To see means/standard deviations for the entire dataset, refer to the nonmissing data columns of part b. 
